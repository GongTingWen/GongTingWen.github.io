...
$("#hintBox1").find(".next").click(function (){
...
$("#hintBox2").find(".next").click(function (){
	if (hintCount == 1) {
		$("#hintBox1").css("display", "none");
		$("#hintBox2").css("display", "none");
...
$("#hintBox3").find(".next").click(function (){
	if (hintCount == 2) {
		$("#hintBox1").css("display", "none");
		$("#hintBox2").css("display", "none");
		$("#hintBox3").css("display", "none");
...
$("#hintBox4").find(".next").click(function (){
	if (hintCount == 3) {
		$("#hintBox1").css("display", "none");
		$("#hintBox2").css("display", "none");
		$("#hintBox3").css("display", "none");
...
$("#hintBox5").find("div").eq(2).click(function (){
	if (hintCount == 4) {
		pageChange(2);
		createRule();
